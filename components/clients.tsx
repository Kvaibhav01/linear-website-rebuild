...
export const Clients = () => (
  <>
    <p className='text-lg text-center mb-12 md:text-xl text-white'>
    ...
    <div className='flex justify-around flex-wrap gap-x-6 gap-y-8 [&_svg]:max-w-[16rem] [&_svg]:basis-[calc(50%-12px)] md:[&_svg]:basis-[calc(16.66%-20px)]'>
      <RampLogo />
